...
class Connection(parent:Activity, local:SurfaceViewRenderer, remote:SurfaceViewRenderer) {
    ...
    init {
        PeerConnectionFactory.initializeAndroidGlobals(parent, true, true, true)
